      ...
      <div class="col-md-8">
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-lg-3 col-md-12 mb-4 mb-lg-0">
                ...
                <div class="bg-image hover-overlay hover-zoom ripple rounded" data-mdb-ripple-color="light">
                  <img src="{{ asset('frontend/img/product/productt-4.jpg') }}"
                    class="w-100">
                  <a href="#!">
            ...
            <div class="row">
              <div class="col-lg-3 col-md-12 mb-4 mb-lg-0">
                <!-- Image -->
                <div class="bg-image hover-overlay hover-zoom ripple rounded" data-mdb-ripple-color="light">
                  <img src="{{ asset('frontend/img/product/productt-3.jpg') }}"
                    class="w-100" />
                  <a href="#!">
                    <div class="mask" style="background-color: rgba(251, 251, 251, 0.2)"></div>
                  </a>
        ...
        <div class="card mb-4">
          <div class="card-body">
            ...
            <p class="mb-0">12.1.2024 - 18.1.2024</p>
          </div>
        </div>
          ...
          <div class="card-body">
            <ul class="list-group list-group-flush">
              ...
              <li
                ...
                <span><strong>Rp 38.000</strong></span>
              </li>
            </ul>
